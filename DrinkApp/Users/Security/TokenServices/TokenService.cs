...
namespace Users.Security.TokenServices
{
    public class TokenService : ITokenService
    {
        ...
        public TokenService(IConfiguration config, ILogger<TokenService> log, IUserService userService)
        {
            this.Logger = log;
        ...
        {
            List<UserRole> UserRoles = await _userService.GetLoginRole(Login);
            ...
            claims.Add(new Claim(ClaimTypes.MobilePhone, Login.PhoneNumber));
